...
//compiler command:
//emcc -I. -o mazes.js -Oz -s ASSERTIONS=1 -s MAXIMUM_MEMORY=8589934592 -s ALLOW_MEMORY_GROWTH=1 -s MODULARIZE=1 -s EXPORT_NAME=createModule --bind maze.cpp dsets.cpp binding.cpp